...
public class DatasetService {
	...
	protected ArrayList<String> negationWords = new ArrayList<>();
	...
	public ArrayList<String> convertFileToArrayList(File file){
...
//                System.out.println(str);
	...
	public DatasetService() throws IOException {
